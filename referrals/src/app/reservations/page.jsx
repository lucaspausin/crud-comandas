	...
	useEffect(() => {
		const fetchData = async () => {
			...
			try {
				...
				const filteredUsers = usersData.filter((user) => user.role_id === 4);
		...
		<div className="flex bg-zinc-50">
			{loading ? ( // Condicional para mostrar un loader
				...
				<>
					<Aside />
					{/* Main Content */}
					<main className="flex-1 p-6 overflow-y-auto z-40">
						...
						<Card className="rounded-xl shadow-lg border-none bg-zinc-50 z-30">
							<CardHeader>
