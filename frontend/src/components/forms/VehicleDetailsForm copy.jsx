...
export default function VehicleDetailsForm({
	...
	const handleSaveSignature = () => {
		if (sigPad.current && !sigPad.current.isEmpty()) {
			...
			try {
				const canvas = sigPad.current.getCanvas();
				// Crear un canvas temporal con dimensiones fijas
				...
				// Establecer dimensiones manteniendo la proporción
				...
				// Dibujar manteniendo la calidad
				...
				<CardContent>
					<dl className="grid grid-cols-2 gap-6 text-sm">
						<div className="flex flex-col items-start gap-2">
							<dt className="font-normal text-zinc-500">Marca:</dt>
							<Input
						...
						<div className="flex flex-col items-start gap-2">
							<dt className="font-normal text-zinc-500">Modelo:</dt>
							<Input
								className="rounded-full bg-white focus-visible:ring-0"
								type="text"
								required
						...
						<div className="flex flex-col items-start gap-2">
							<dt className="font-normal text-zinc-500">Año de fabricacion:</dt>
							<Input
								className="rounded-full bg-white focus-visible:ring-0"
								type="text"
								required
						...
						<div className="flex flex-col items-start gap-2">
							<dt className="font-normal text-zinc-500">Patente:</dt>
							<Input
								className="rounded-full bg-white focus-visible:ring-0"
								type="text"
								required
						...
						<div className="flex flex-col items-start gap-2">
							<dt className="font-normal text-zinc-500">Dominio:</dt>
							<Input
								className="rounded-full bg-white focus-visible:ring-0"
								type="text"
								required
						...
						<div className="flex flex-col items-start gap-2">
							<dt className="font-normal text-zinc-500">Color:</dt>
							<Input
								className="rounded-full bg-white focus-visible:ring-0"
								type="text"
								required
								...
								<div className="space-y-4">
									...
									<div className="space-y-4">
										...
										<div>
											...
											<Textarea
												value={formData[`observacion${selectedPoint.id}`] || ""}
												onChange={(e) =>
													handleInputChange(
														`observacion${selectedPoint.id}`,
														e.target.value
													)
												}
