			...
			<main className="flex flex-col items-stretch justify-normal p-6 z-50">
				<div className="flex items-center justify-between mb-6">
					<div className="flex items-center gap-2">
						...
						<h2 className="text-zinc-700 text-base">Editar Checklist</h2>
					</div>
				</div>
				<div className="grid gap-6 w-full">
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<Card className="rounded-xl shadow-lg border-none">
							...
							<CardContent>
								<dl className="grid grid-cols-2 gap-2 text-sm">
									<dt className="font-normal text-zinc-500">Comanda:</dt>
									<dd>{comanda.comandas_tecnica_comanda_idTocomandas.id}</dd>
									<dt className="font-normal text-zinc-500">Servicio:</dt>
									<dd>Instalación de GNC</dd>
									<dt className="font-normal text-zinc-500">Creado:</dt>
									<dd>
						...
						<Card className="rounded-xl shadow-lg border-none">
							...
							<CardContent>
								<dl className="grid grid-cols-2 gap-2 text-sm">
									<dt className="font-normal text-zinc-500">Nombre:</dt>
									<dd>
										{comanda.comandas_tecnica_comanda_idTocomandas
											.boletos_reservas.clientes?.nombre_completo || "N/A"}
									</dd>
									<dt className="font-normal text-zinc-500">DNI:</dt>
									<dd>
										{comanda.comandas_tecnica_comanda_idTocomandas
											.boletos_reservas.clientes?.dni || "N/A"}
									</dd>
									<dt className="font-normal text-zinc-500">Domicilio:</dt>
									<dd>
										{comanda.comandas_tecnica_comanda_idTocomandas
											.boletos_reservas.clientes?.domicilio || "N/A"}
									</dd>
									<dt className="font-normal text-zinc-500">Localidad:</dt>
									<dd>
										{comanda.comandas_tecnica_comanda_idTocomandas
											.boletos_reservas.clientes?.localidad || "N/A"}
									</dd>
									<dt className="font-normal text-zinc-500">Teléfono:</dt>
